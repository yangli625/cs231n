...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout_layer3, grads['W3'], grads['b3'] = affine_backward(dout, layer3_cache)
        dout_layer2, grads['W2'], grads['b2'] = affine_relu_backward(dout_layer3, layer2_cache)
        dout_layer1, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout_layer2, layer1_cache)
