...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        out, temporal_affine_cache = temporal_affine_forward(h, W_vocab, b_vocab)
        loss, dout = temporal_softmax_loss(out, captions_out, mask, False)
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(1, max_length, 1):
            ...
            captions[:,i] = inds
            captions[mask==False,i] = self._null
            mask[inds==self._end] = 0
            x = W_embed[captions[:,i].flatten(), :]
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        return captions
